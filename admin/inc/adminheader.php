        ...
        <div class="grid_12 header-repeat">
            <div id="branding">
				...
				<div class="floatleft middle">
					<h1>Rumman's Platform</h1>
					<p>rummanphp.bd-techzone.com/blog1</p>
				</div>
<?php
                ...
                <div class="floatright">
                    ...
                    <div class="floatleft marginleft10">
                        <ul class="inline-ul floatleft">
                            <li><?php echo ucfirst(Session::get('username'));
...
<?php
            $query= "select * from forcontact where notification ='0'";
...
?>  
                ...
                <li class="ic-charts"><a href="rummanphp.bd-techzone.com/blog1" target="_blank"><span>Visit Website</span></a></li>
<?php 
     if( Session::get('Userrole') =='0'){ ?>
